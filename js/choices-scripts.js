...
const introMessage = "it's your birthday! what do you want to do first?";

let textIndex = 0;

function animateText() {
    if (textIndex < introMessage.length) {
        introText.innerHTML += introMessage.charAt(textIndex);
        textIndex++;
...
window.onload = function() {
    introText.innerHTML = ''; // Clear any pre-existing content
    animateText();
