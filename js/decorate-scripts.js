const decorateText = document.getElementById("decorateText");
const decorateMessage = "you're decorating the place! how will you do it?";

let textIndex = 0;

function animateText() {
    if (textIndex < decorateMessage.length) {
        decorateText.innerHTML += decorateMessage.charAt(textIndex);
        textIndex++;
...
window.onload = function() {
    decorateText.innerHTML = ''; // Clear any pre-existing content
    animateText();
