...
const recipeMessage = "you followed the recipe perfectly! the cake looks amazing!";

let textIndex = 0;

function animateText() {
    if (textIndex < recipeMessage.length) {
        recipeText.innerHTML += recipeMessage.charAt(textIndex);
        textIndex++;
...
window.onload = function() {
    recipeText.innerHTML = ''; // Clear any pre-existing content
    animateText();
