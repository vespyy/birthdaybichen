...
const cakeMessage = "oh no! the cake isn't ready. what will you do?";

let textIndex = 0;

function animateText() {
    if (textIndex < cakeMessage.length) {
        cakeText.innerHTML += cakeMessage.charAt(textIndex);
        textIndex++;
...
window.onload = function() {
    cakeText.innerHTML = ''; // Clear any pre-existing content
    animateText();
